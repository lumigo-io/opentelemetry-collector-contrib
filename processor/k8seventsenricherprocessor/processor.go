...
func (kp *kubernetesprocessor) addRootOwnerReference(ctx context.Context, logRecord *plog.LogRecord) error {
	...
	for currentObjectReference != nil {
		...
		if err != nil {
			return fmt.Errorf("cannot retrieve owner reference of object reference %v", currentObjectReference)
		}
	...
	if currentObjectReference != nil {
		...
		if err != nil {
			return fmt.Errorf("cannot convert root owner reference to unstructured: %v", currentObjectReference)
		}
